...
wget https://raw.githubusercontent.com/iAboothahir/20-20/master/kernel_script/X00TD-perf_defconfig-4.4
cp -vr X00TD-perf_defconfig-4.4 arch/arm64/configs/X00TD-perf_defconfig
